(function() {
    ...
    // ============================================================
    const allProducts = [
        { id: 1, name: "Monkey D. Luffy Figure", category: "One Piece", price: 89.99, image: "img/01-luffy.png",
            description: "Figura detallada del capitán de los Sombrero de Paja.", featured: true },
        { id: 2, name: "Roronoa Zoro Figure", category: "One Piece", price: 79.99, image: "img/02-zoro.png",
            description: "El espadachín de la tripulación en pose de combate.", featured: true },
        { id: 3, name: "Going Merry Model", category: "One Piece", price: 129.99, image: "img/03-going-merry.png",
            description: "Réplica del querido barco de la tripulación.", featured: true },
        { id: 4, name: "Straw Hat Replica", category: "One Piece", price: 34.99, image: "img/04-straw-hat.png",
            description: "Réplica del sombrero de paja emblemático.", featured: false },
        { id: 5, name: "Portgas D. Ace Figure", category: "One Piece", price: 69.99, image: "img/05-ace.png",
            description: "Figura del comandante de la segunda división.", featured: true },
        { id: 6, name: "Thousand Sunny Model", category: "One Piece", price: 149.99, image: "img/06-thousand-sunny.png",
            description: "El barco actual de los Sombrero de Paja a escala.", featured: false },
        { id: 7, name: "Naruto Uzumaki Figure", category: "Naruto", price: 79.99, image: "img/07-naruto.png",
            description: "Figura del séptimo Hokage en acción.", featured: true },
        { id: 8, name: "Sasuke Uchiha Figure", category: "Naruto", price: 74.99, image: "img/08-sasuke.png",
            description: "El último Uchiha en pose característica.", featured: false },
        { id: 9, name: "Kakashi Hatake Figure", category: "Naruto", price: 64.99, image: "img/09-kakashi.png",
            description: "El ninja copia con su libro favorito.", featured: false },
        { id: 10, name: "Itachi Uchiha Figure", category: "Naruto", price: 84.99, image: "img/10-itachi.png",
            description: "Figura del legendario miembro del clan Uchiha.", featured: false },
        { id: 11, name: "Konoha Symbol Collectible", category: "Naruto", price: 24.99, image: "img/11-konoha.png",
            description: "Símbolo de la Aldea Oculta de la Hoja.", featured: false },
        { id: 12, name: "Kurama Collector Figure", category: "Naruto", price: 119.99, image: "img/12-kurama.png",
