...
│   ├── hero.jpg            # Imagen de fondo del hero (referenciada)
│   └── favicon.png         # Favicon (referenciado)
├── img/                    # Carpeta de imágenes propias
│   ├── 1.Instant Talent.PNG    # Logo principal
│   └── 2.Politicas.PNG         # Imagen de sección políticas
...
> ![header](../../Assets/img/01-instant-talent/01-header.PNG)  
> ![Misión y Visión](../../Assets/img/01-instant-talent/02-mision-y-vision.PNG)  
> ![Valores Corporativos](../../Assets/img/01-instant-talent/03-valores-corporativos.PNG)  
> ![Objetivos](../../Assets/img/01-instant-talent/04-objetivos.PNG)  
> ![Proceso](../../Assets/img/01-instant-talent/05-proceso.PNG)  
> ![Footer](../../Assets/img/01-instant-talent/06-footer.PNG)  
